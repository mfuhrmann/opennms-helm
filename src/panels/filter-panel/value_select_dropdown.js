...
export class OnmsValueSelectDropdownCtrl {
  ...
  */
  ...
  updateLinkText() {
    console.log('dropdown.updateLinkText');
  ...
  clearSelections() {
    console.log('dropdown.clearSelections');
  ...
  selectTag(tag) {
    console.log('dropdown.selectTag', tag);
  ...
  keyDown(evt) {
    console.log('dropdown.keyDown', evt);
    if (evt.keyCode === 27) {
      this.hide();
    }
    if (evt.keyCode === 40) {
  ...
  moveHighlight(direction) {
    console.log('dropdown.moveHighlight', direction);
  ...
  selectValue(option, event, commitChange, excludeOthers) {
    console.log('dropdown.updateLinkText', option, event, commitChange, excludeOthers);
    if (!option) {
      return;
    }
  ...
  selectionsChanged(commitChange) {
    console.log('dropdown.selectionsChanged', commitChange);
    this.selectedValues = _.filter(this.options, { selected: true });
  ...
  commitChanges() {
    console.log('dropdown.commitChanges');
  ...
  queryChanged() {
    console.log('dropdown.queryChanged');
    this.highlightIndex = -1;
