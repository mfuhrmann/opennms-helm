...
export const Examples = [
    new Example("Show all nodes", new API.Filter()),
    new Example("Show all nodes for location 'Default'",
        new API.Filter().withAndRestriction(new API.Restriction("location.locationName", API.Comparators.EQ, 'Default'))),
    new Example("Show all nodes in category 'Servers'",
